...
set "SRC_COL=D:\TrueScent\Collider-bsgs\x64"
set "DST_TC=%~dp0tools\TrueCollider"
set "DST_MK=%~dp0tools\TrueMkeyCollider"
set "DST_COL=%~dp0tools\Collider-bsgs"
...
echo [+] Syncing Collider-bsgs runtime...
mkdir "%DST_COL%" 2>nul
if exist "%SRC_COL%\Collider.exe" copy /Y "%SRC_COL%\Collider.exe" "%DST_COL%\" >nul
if exist "%SRC_COL%\Coillider180.exe" copy /Y "%SRC_COL%\Coillider180.exe" "%DST_COL%\Collider180.exe" >nul
if exist "D:\TrueScent\Collider-bsgs\README.md" copy /Y "D:\TrueScent\Collider-bsgs\README.md" "%DST_COL%\" >nul
if exist "%~dp0docs\COLLIDER_BSGS.md" copy /Y "%~dp0docs\COLLIDER_BSGS.md" "%DST_COL%\TRUECOLLIDER_MAP.md" >nul
