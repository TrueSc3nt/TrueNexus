...
TOOLS: list[Tool] = [
    ...
    {"id": "collider-bsgs", "name": "Collider-bsgs recipe (pp717)", "kind": "recipe", "status": "recipe",
     "cli": "-m bsgs -B random -U cuda", "note": "Maps Collider -pb/-pk/-pke/-w to -f/-r/-n/-k", "gpu": True},
